  ...
  return (
    <div className="pt-24 pb-20 px-4 md:px-12 max-w-[1440px] mx-auto min-h-screen relative z-10">
      ...
      <section className="mb-20">
        <div className="flex items-end justify-between mb-12">
          <h1 className="font-display text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white flex items-center gap-4">
            <span className="w-10 h-1.5 bg-gradient-to-r from-brand-amber-yellow to-brand-coral-pink rounded-full block"></span>
            Top Rated — Shows
          </h1>
        </div>
        {renderGrid(filteredShows, showsGridRef, 'show-card', 'tv', loadingShows, 'star', q ? 'No shows match your search.' : 'No top-rated shows found.', 'Loading top shows...')}
      </section>
      ...
      <section>
        ...
        {renderGrid(filteredMovies, moviesGridRef, 'movie-card', 'movie', loadingMovies, 'movie', q ? 'No movies match your search.' : 'No top-rated movies found.', 'Loading top movies...')}
      </section>
    </div>
  );
}
